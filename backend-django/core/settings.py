...
SECRET_KEY = os.getenv('SECRET KEY','django-insecure-iliey-uzxv&ydv(c$o^o0_(^qhr@w)992@+(et*l(shpm5npw%')
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60), # Token-ul normal e valabil o ora
